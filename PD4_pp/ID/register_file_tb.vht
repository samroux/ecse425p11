...
architecture register_file_arch of register_file_tb is
	...
	begin
		...
		begin
			...
			assert (reg_output = "00000000") severity ERROR;
			report "______";
			...
			MemWrite <= '0';
			wait for clock_period/2;
			assert (reg_output = "10000000") severity ERROR;
